...
public class ClassUtils {
    ...
    public static <T> List<T> getObjectsWithInterface(Context context, Class<T> clazz, String path) {
        ...
        try {
            ...
            if (objectList.size() == 0) {
                LogUtil.e("No files were found, check your configuration please!");
            }
        } catch (Exception e) {
            e.getStackTrace();
            LogUtil.e("getObjectsWithInterface error, " + e.getMessage());
        }
    ...
    public static List<String> getFileNameByPackageName(Context context, String packageName) throws PackageManager.NameNotFoundException, IOException {
        ...
        for (String path : getSourcePaths(context)) {
            ...
            try {
                ...
                LogUtil.e("Scan map file in dex files made error.");
            } finally {
                if (null != dexfile) {
                    try {
                        dexfile.close();
        ...
        LogUtil.e("Filter " + classNames.size() + " classes by packageName <" + packageName + ">");
        return classNames;
    }
    ...
    private static List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && null != applicationInfo.splitSourceDirs) {
            ...
            LogUtil.d("Found InstantRun support");
        } else {
            try {
                ...
                LogUtil.e("InstantRun support error, " + e.getMessage());
            }
        }
    ...
    private static boolean isVMMultidexCapable() {
        ...
        LogUtil.i("VM with name " + vmName + (isMultidexCapable ? " has multidex support" : " does not have multidex support"));
