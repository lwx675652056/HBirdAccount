package com.hbird.common.calendar.weiget;
...
import com.hbird.common.calendar.bean.AttrsBean;
import com.hbird.common.calendar.bean.DateBean;
import com.hbird.common.calendar.listener.CalendarViewAdapter;
import com.hbird.common.calendar.listener.OnMultiChooseListener;
import com.hbird.common.calendar.listener.OnSingleChooseListener;
...
public class MonthView extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            childView.measure(MeasureSpec.makeMeasureSpec(itemSize, MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(itemSize, MeasureSpec.EXACTLY));
        }
    }
