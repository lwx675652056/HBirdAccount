...
import com.hbird.base.di.component.other.DaggerDBComponent;
...
public class GreenDBManager implements IDBManager {
    ...
    @Inject
    WaterOrderTableManager mWaterOrderTableManager;
    @Inject
    HbirdIncomeTypeManager mHbirdIncomeTypeManager;
    @Inject
    HbirdSpendTypeManager mHbirdSpendTypeManager;
    @Inject
    HbirdUserCommUseIncomManager mHbirdUserCommUseIncomManager;
    @Inject
    HbirdUserCommUseSpendManager mHbirdUserCommUseSpendManager;
    @Inject
    HbirdUserCommTypePriorityManager mHbirdUserCommTypePriorityManager;
    ...
    public void putTableManager(SimpleArrayMap<Object, ITableManger> mapTables) {
        ...
        mapTables.put(WaterOrderCollect.class, mWaterOrderTableManager);
        mapTables.put(HbirdIncomeType.class, mHbirdIncomeTypeManager);
        mapTables.put(HbirdSpendType.class, mHbirdSpendTypeManager);
        mapTables.put(HbirdUserCommUseIncome.class, mHbirdUserCommUseIncomManager);
        mapTables.put(HbirdUserCommUseSpend.class, mHbirdUserCommUseSpendManager);
        mapTables.put(HbirdUserCommTypePriority.class, mHbirdUserCommTypePriorityManager);
    }
