...
/** 
 * DAO for table "HBIRD_INCOME_TYPE".
*/
public class HbirdIncomeTypeDao extends AbstractDao<HbirdIncomeType, Void> {

    public static final String TABLENAME = "HBIRD_INCOME_TYPE";

    /**
     * Properties of entity HbirdIncomeType.<br/>
     * Can be used for QueryBuilder and for referencing column names.
     */
    public static class Properties {
        public final static Property Id = new Property(0, String.class, "id", false, "ID");
        public final static Property IncomeName = new Property(1, String.class, "incomeName", false, "INCOME_NAME");
    ...
    public HbirdIncomeTypeDao(DaoConfig config) {
        super(config);
    }
    
    public HbirdIncomeTypeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HBIRD_INCOME_TYPE\" (" + //
                "\"ID\" TEXT UNIQUE ," + // 0: id
                "\"INCOME_NAME\" TEXT," + // 1: incomeName
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HBIRD_INCOME_TYPE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, HbirdIncomeType entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, HbirdIncomeType entity) {
        stmt.clearBindings();
    ...
    @Override
    public HbirdIncomeType readEntity(Cursor cursor, int offset) {
        HbirdIncomeType entity = new HbirdIncomeType( //
            cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0), // id
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // incomeName
    ...
    @Override
    public void readEntity(Cursor cursor, HbirdIncomeType entity, int offset) {
        entity.setId(cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0));
        entity.setIncomeName(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
    ...
    @Override
    protected final Void updateKeyAfterInsert(HbirdIncomeType entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(HbirdIncomeType entity) {
        return null;
    }

    @Override
    public boolean hasKey(HbirdIncomeType entity) {
        // TODO
        return false;
    }
