...
*/
  ...
  */
    ...
    * */
    ...
    /**
     * @param time 当前的时间
     * @return 当前的天   将long转换为yyyy/MM/dd
     */
    public static String getDays(long time) {
        return new SimpleDateFormat("yyyy/MM/dd").format(time);
    }

    public static String getDaysDot(long time) {
        return new SimpleDateFormat("yyyy.MM.dd").format(time);
    }
    ...
    //将毫秒时间值转换成 dd
    public static String getMonthDayTodd(long time){
        String s = null;
        Date d = new Date(time);
    ...
    //将毫秒时间值转换成 mm
    public static String getMonth2M(long time){
        String s = null;
        Date d = new Date(time);
    ...
    //将毫秒时间值转换成 int(月份)
    public static int getMonthToNum(){
        Calendar calendar=Calendar.getInstance();
