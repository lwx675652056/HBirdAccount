...
public interface UrlConstants {
    boolean IS_RELEASE = true;//是否正式环境运行 true为正式
...
//    public final static String PLATFORM_CONFIG_URL = IS_RELEASE ? BASE_URL : BASE_URL_HTTPS;
//    public final static String BASE_H5_URL = IS_RELEASE ? BASE_URL_H5 : BASE_URL_HTTPS_H5;
