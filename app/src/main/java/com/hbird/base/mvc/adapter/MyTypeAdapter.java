 ...
 */
public class MyTypeAdapter extends BaseAdapter implements DragAdapterInterface {

    private List<ZhiChuTagReturn.ResultBean.CommonListBean> datas = new ArrayList<>();
    ...
    public MyTypeAdapter(Context context,BaseFragement glideContext) {
        this.context = context;
        this.mContext = glideContext;
    }

    public void setDatas(List<ZhiChuTagReturn.ResultBean.CommonListBean> datas, String showType) {
        this.datas.clear();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ZhiChuTagReturn.ResultBean.CommonListBean bean = datas.get(position);
        final Holder holder;
        if (convertView == null) {
            holder = new Holder();
    ...
    public void reOrder(int startPosition, int endPosition) {
        if (endPosition < datas.size()) {
            ...
            ZhiChuTagReturn.ResultBean.CommonListBean object = datas.remove(startPosition);
    ...
    public interface CommondataChangeInterface {
        ...
        void setdatas(List<ZhiChuTagReturn.ResultBean.CommonListBean> datas);
    }
}
