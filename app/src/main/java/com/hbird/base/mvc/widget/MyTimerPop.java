...
/**
 * Created by liul on 2018/06/29.
 * 自定义pop 记账首页 - 明细 - 时间选择
 */

public class MyTimerPop implements View.OnClickListener{
    ...
    private void initPopView(View popView) {
        ...
        mAdapter = new MyRecyclerViewAdapter(context,listYear,yearItem);
        ...
        recyclerView.addItemDecoration(new MyDividerItemDecoration(
                context, LinearLayoutManager.HORIZONTAL, 1, context.getResources().getColor(R.color.line)));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(mAdapter);
        MoveToPosition(new LinearLayoutManager(context),recyclerView,yearItem);
        //月
        m2LayoutManager = new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false);
        monthAdapter = new MonthRecyclerViewAdapter(context,listMonth,monthItem);
        ...
        mAdapter.setOnItemClickListener(new MyRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                listener.getYearList(listYear.get(position));
                //popupWindow.dismiss();
            }
        ...
        monthAdapter.setOnItemClickListener(new MonthRecyclerViewAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
