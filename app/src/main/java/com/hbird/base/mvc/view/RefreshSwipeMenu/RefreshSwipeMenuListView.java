package com.hbird.base.mvc.view.RefreshSwipeMenu;
 ...
 * SwipeRefreshDemo 上下拉刷新 左滑编辑 ，删除  (上下拉刷新 已屏蔽)
 */
...
public class RefreshSwipeMenuListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private boolean mEnablePullRefresh = false;//能否下拉刷新  修改为false不要下拉刷新 liul
    ...
    private void init(final Context context) {
        ...
        // 初始化尾部视图
        mFooterView = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.xlistview_footers, null, false);
