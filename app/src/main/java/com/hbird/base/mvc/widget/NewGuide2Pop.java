...
public class NewGuide2Pop implements View.OnClickListener {
    ...
    public NewGuide2Pop(Context context, View view, String title, int type, PopDismissListener dismissListener) {
    ...
    private void initPop() {
        // 一个自定义的布局，作为显示的内容
        View popView = LayoutInflater.from(context).inflate(R.layout.pop_new2_guide, null);
        ...
        // 设置弹出窗体显示时的动画，从下往上弹出
        popupWindow.setAnimationStyle(R.style.new_guide_up_anim);
    }
