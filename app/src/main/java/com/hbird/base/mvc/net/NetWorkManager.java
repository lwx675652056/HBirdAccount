...
public class NetWorkManager {
    ...
    public void getZiChanInfo(String token,final CallBack callBack){
        Observable<ResponseBody> observable = DevRing.httpManager().getService(ApiService.class).getAssets(token);
        DevRing.httpManager().commonRequest(observable, new CommonObserver<ResponseBody>(){
            @Override
            public void onResult(ResponseBody result) {
                try {
