...
public class IndexFragementAdapterOld extends BaseAdapter {

    List<indexBaseListBean> listBean;
    Context context;
    IndexFragementOld mContext;

    public IndexFragementAdapterOld(Context context, IndexFragementOld mContext, List<indexBaseListBean> list) {
