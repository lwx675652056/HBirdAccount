...
public class NewGuidePop implements View.OnClickListener {
    ...
    public NewGuidePop(Context context, View view,String title,int types, PopDismissListener dismissListener) {
    ...
    private void initPop() {
        // 一个自定义的布局，作为显示的内容
        View popView = LayoutInflater.from(context).inflate(R.layout.pop_new_guide, null);
    ...
    private void initPopView(View popView) {
        ...
        TextView texts = (TextView)popView.findViewById(R.id.tv_texts);
        LinearLayout content02 = (LinearLayout)popView.findViewById(R.id.ll_content02);
        if(type==1){
            text.setText(title);
