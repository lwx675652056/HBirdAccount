...
import com.hbird.base.util.SizeConvertUtil;
...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        //设置画笔颜色
        centerLinePaint.setColor(ContextCompat.getColor(mContext, R.color.colorPrimary));
    ...
    private void drawData(Canvas canvas) {
        if(null==itemLsit || itemLsit.size()==0){
            return;
        }
        if (!itemLsit.isEmpty()) {
            // 绘制中间data
