...
public class MyGridViewAdapter extends BaseAdapter {
     ...
     */
    private List<AddMoreTypeBean.ResultBean.AllListBean.SpendTypeSonsBean> itemGridList;
    ...
    public MyGridViewAdapter(Context mContext, List<AddMoreTypeBean.ResultBean.AllListBean.SpendTypeSonsBean> itemGridList
