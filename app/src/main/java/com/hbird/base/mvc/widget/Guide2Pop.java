...
public class Guide2Pop implements View.OnClickListener {
    ...
    public Guide2Pop(Context context, View view, String title,  PopDismissListener dismissListener) {
    ...
    private void initPop() {
        // 一个自定义的布局，作为显示的内容
        View popView = LayoutInflater.from(context).inflate(R.layout.pop_guide_2, null);
