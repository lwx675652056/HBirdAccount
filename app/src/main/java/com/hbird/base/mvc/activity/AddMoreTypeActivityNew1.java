 ...
 * @Description: 记一笔 - 添加类别
 */
public class AddMoreTypeActivityNew1 extends BaseActivity<BaseActivityPresenter> implements View.OnClickListener {
...
//        accountBookId = Integer.valueOf(id);
    ...
    private void setDate(ZhiChuTagReturnNew date) {
        ...
        if (callBacka != null) {
            ...
            GlideApp.with(AddMoreTypeActivityNew1.this)
            ...
            NetWorkManager.getInstance().setContext(this)
                    .postShouRuType(callBackb.getId(), Integer.parseInt(a), token, new NetWorkManager.CallBack() {
                        ...
                        public void onSuccess(BaseReturn b) {
                            ...
                            SPUtil.setPrefString(AddMoreTypeActivityNew1.this, com.hbird.base.app.constant.CommonTag.LABEL_VERSION, version);
                            insertDates();
                            setResult(123);
                            finish();
                        }
