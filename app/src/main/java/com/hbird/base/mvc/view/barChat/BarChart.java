package com.hbird.base.mvc.view.barChat;
...
public class BarChart extends LBaseView {
    ...
    protected int defaultLineColor = Color.argb(255, 250, 209, 200);//柱形图的颜色
    ...
    protected int myBorderColor = Color.argb(255, 255, 255, 255);//柱状图底部 横线颜色 （白色）
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mDatas.size(); i++) {
            ...
            //更改最底部月份的 宽度及高度 （默认的是在列表最下面显示 根据字体大小高度随之变化）
