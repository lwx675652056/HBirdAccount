 ...
 */
public class MyType2Adapter extends BaseAdapter implements DragAdapterInterface {

    private List<ShouRuTagReturn.ResultBean.CommonListBean> datas = new ArrayList<>();
    ...
    public MyType2Adapter(Context context, BaseFragement glideContext) {
        this.context = context;
        this.mContext = glideContext;
    }

    public void setDatas(List<ShouRuTagReturn.ResultBean.CommonListBean> datas, String showType) {
        this.datas.clear();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ShouRuTagReturn.ResultBean.CommonListBean bean = datas.get(position);
        Holder holder;
        if (convertView == null) {
            holder = new Holder();
    ...
    public void reOrder(int startPosition, int endPosition) {
        if (endPosition < datas.size()) {
            ShouRuTagReturn.ResultBean.CommonListBean object = datas.remove(startPosition);
    ...
    public interface CommondataChangeInterface {
        ...
        void setdatas(List<ShouRuTagReturn.ResultBean.CommonListBean> datas);
    }
}
