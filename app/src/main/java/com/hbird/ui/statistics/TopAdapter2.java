...
public class TopAdapter2 extends BaseAdapter<StatisticsTopBean> {

    private OnItemClickListener listener;

    public TopAdapter2(Context context, List<StatisticsTopBean> list, int layoutId, OnItemClickListener listener) {
