...
public class TypeDetailModle extends BaseViewModel {

    public TypeDetailModle(@NonNull Application application) {
        super(application);
    }

    // 获取类别排行
    public void getData(String sql, String firstDay, String lastDay, onRankingCallBack callBack) {
