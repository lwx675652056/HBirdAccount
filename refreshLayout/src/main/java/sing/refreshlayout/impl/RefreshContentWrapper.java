...
import sing.refreshlayout.listener.CoordinatorLayoutListener;
import sing.refreshlayout.util.DesignUtil;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static sing.refreshlayout.util.ScrollBoundaryUtil.canScrollDown;
import static sing.refreshlayout.util.ScrollBoundaryUtil.canScrollUp;
import static sing.refreshlayout.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
import static sing.refreshlayout.util.SmartUtil.isScrollableView;
import static sing.refreshlayout.util.SmartUtil.measureViewHeight;
import static sing.refreshlayout.util.SmartUtil.scrollListBy;
