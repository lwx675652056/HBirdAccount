...
import sing.refreshlayout.api.DefaultRefreshFooterCreator;
import sing.refreshlayout.api.DefaultRefreshHeaderCreator;
import sing.refreshlayout.api.RefreshContent;
...
import sing.refreshlayout.constant.DimensionStatus;
import sing.refreshlayout.constant.RefreshState;
import sing.refreshlayout.constant.SpinnerStyle;
import sing.refreshlayout.footer.ClassicsFooter;
import sing.refreshlayout.header.ClassicsHeader;
import sing.refreshlayout.impl.RefreshContentWrapper;
import sing.refreshlayout.impl.RefreshFooterWrapper;
import sing.refreshlayout.impl.RefreshHeaderWrapper;
import sing.refreshlayout.listener.OnLoadMoreListener;
import sing.refreshlayout.listener.OnMultiPurposeListener;
import sing.refreshlayout.listener.OnRefreshListener;
import sing.refreshlayout.listener.OnRefreshLoadMoreListener;
import sing.refreshlayout.listener.OnStateChangedListener;
import sing.refreshlayout.util.DelayedRunnable;
...
import sing.refreshlayout.util.ViscousFluidInterpolator;
...
import static sing.refreshlayout.util.DensityUtil.dp2px;
import static sing.refreshlayout.util.SmartUtil.isScrollableView;
...
//                mRefreshContent.onActionUpOrCancel();
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link sing.refreshlayout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link sing.refreshlayout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
